...
```text
plugins/ふりがな自動入力/FuriganaAutoInput
```

## 難読化版場所

```text
plugins/ふりがな自動入力/FuriganaAutoInpute
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/ふりがな自動入力/FuriganaAutoInput`
- 難読化版: `plugins/ふりがな自動入力/FuriganaAutoInpute`
...
1. `plugins/ふりがな自動入力/specification.md` を確認する。
2. `plugins/ふりがな自動入力/codex/troubleshooting.md`、`plugins/ふりがな自動入力/codex/handover-YYYY-MM-DD.md`、`plugins/ふりがな自動入力/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/ふりがな自動入力/FuriganaAutoInput` であること。
- 難読化済みファイル `plugins/ふりがな自動入力/FuriganaAutoInpute` を直接編集していないこと。
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/ふりがな自動入力/FuriganaAutoInput` から実行します。
- 難読化済みファイルは `plugins/ふりがな自動入力/FuriganaAutoInpute` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/ふりがな自動入力/FuriganaAutoInput` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/ふりがな自動入力/FuriganaAutoInpute` の `contents` 配下を基準に作成します。
...
```text
plugins/ふりがな自動入力/codex/handover-YYYY-MM-DD.md
plugins/ふりがな自動入力/codex/next-tasks.md
```
