...
- 対象パス: `plugins/キーワードルックアップ`
- 元ソース: `plugins/キーワードルックアップ/KeywordLookup`
- 難読化済み版: `plugins/キーワードルックアップ/KeywordLookupe`
- 解析対象ファイル数: 33
- ファイル種別集計: CSS: 8, HTML: 2, JS: 8, JSON: 2, MD: 7, PNG: 2, PUBKEY: 2, SIGNATURE: 2

### 元ソース主要ファイル
- `plugins/キーワードルックアップ/KeywordLookup/contents/css/51-modern-default.css`
- `plugins/キーワードルックアップ/KeywordLookup/contents/css/config.css`
- `plugins/キーワードルックアップ/KeywordLookup/contents/css/desktop.css`
- `plugins/キーワードルックアップ/KeywordLookup/contents/css/mobile.css`
- `plugins/キーワードルックアップ/KeywordLookup/contents/html/config.html`
- `plugins/キーワードルックアップ/KeywordLookup/contents/image/icon.png`
- `plugins/キーワードルックアップ/KeywordLookup/contents/js/certification.js`
- `plugins/キーワードルックアップ/KeywordLookup/contents/js/config.js`
- `plugins/キーワードルックアップ/KeywordLookup/contents/js/desktop.js`
- `plugins/キーワードルックアップ/KeywordLookup/contents/js/mobile.js`
- `plugins/キーワードルックアップ/KeywordLookup/contents/manifest.json`
- `plugins/キーワードルックアップ/KeywordLookup/PUBKEY`
- `plugins/キーワードルックアップ/KeywordLookup/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/キーワードルックアップ/KeywordLookupe/contents/css/51-modern-default.css`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/css/config.css`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/css/desktop.css`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/css/mobile.css`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/html/config.html`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/image/icon.png`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/js/certification.js.obfuscated.js`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/js/config.js.obfuscated.js`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/js/desktop.js.obfuscated.js`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/js/mobile.js.obfuscated.js`
- `plugins/キーワードルックアップ/KeywordLookupe/contents/manifest.json`
- `plugins/キーワードルックアップ/KeywordLookupe/PUBKEY`
- `plugins/キーワードルックアップ/KeywordLookupe/SIGNATURE`

### 保守資料・その他
- `plugins/キーワードルックアップ/codex/handover-2026-06-23.md`
- `plugins/キーワードルックアップ/codex/next-tasks.md`
- `plugins/キーワードルックアップ/codex/test-plan.md`
- `plugins/キーワードルックアップ/codex/troubleshooting.md`
- `plugins/キーワードルックアップ/codex/work-instructions.md`
- `plugins/キーワードルックアップ/decisions/README.md`
- `plugins/キーワードルックアップ/specification.md`
...
- 元ソース優先: plugins/キーワードルックアップ/KeywordLookup
- 難読化済みファイル: plugins/キーワードルックアップ/KeywordLookupe（参考情報として扱い、直接修正対象外）
