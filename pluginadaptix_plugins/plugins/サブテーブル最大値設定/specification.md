...
- 対象パス: `plugins/サブテーブル最大値設定`
- 元ソース: `plugins/サブテーブル最大値設定/SubtableMaxValue`
- 難読化済み版: `plugins/サブテーブル最大値設定/SubtableMaxValuee`
- 解析対象ファイル数: 33
- ファイル種別集計: CSS: 8, HTML: 2, JS: 8, JSON: 2, MD: 7, PNG: 2, PUBKEY: 2, SIGNATURE: 2

### 元ソース主要ファイル
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/css/51-modern-default.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/css/config.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/css/desktop.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/css/mobile.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/html/config.html`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/image/icon.png`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/js/certification.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/js/config.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/js/desktop.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/js/mobile.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/contents/manifest.json`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/PUBKEY`
- `plugins/サブテーブル最大値設定/SubtableMaxValue/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/css/51-modern-default.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/css/config.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/css/desktop.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/css/mobile.css`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/html/config.html`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/image/icon.png`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/js/certification.js.obfuscated.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/js/config.js.obfuscated.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/js/desktop.js.obfuscated.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/js/mobile.js.obfuscated.js`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/contents/manifest.json`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/PUBKEY`
- `plugins/サブテーブル最大値設定/SubtableMaxValuee/SIGNATURE`

### 保守資料・その他
- `plugins/サブテーブル最大値設定/codex/handover-2026-06-23.md`
- `plugins/サブテーブル最大値設定/codex/next-tasks.md`
- `plugins/サブテーブル最大値設定/codex/test-plan.md`
- `plugins/サブテーブル最大値設定/codex/troubleshooting.md`
- `plugins/サブテーブル最大値設定/codex/work-instructions.md`
- `plugins/サブテーブル最大値設定/decisions/README.md`
- `plugins/サブテーブル最大値設定/specification.md`
...
- version: 1.0.6
- type: APP
- name.ja: サブテーブル最大値設定プラグイン_test
- name.en: Subtable maximum value limit
- description.ja: [PluginAdaptiX] v1.0.6 サブテーブル最大値を設定することができます
- icon: image/icon.png
...
- kintoneイベントの `event.error` による保存抑止を確認した。
...
- 元ソース優先: plugins/サブテーブル最大値設定/SubtableMaxValue
- 難読化済みファイル: plugins/サブテーブル最大値設定/SubtableMaxValuee（参考情報として扱い、直接修正対象外）
