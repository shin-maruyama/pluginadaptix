...
```text
plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente
```
...
1. `plugins/ユーザー選択→文字列1行代入/specification.md` を確認する。
2. `plugins/ユーザー選択→文字列1行代入/codex/troubleshooting.md`、`plugins/ユーザー選択→文字列1行代入/codex/handover-YYYY-MM-DD.md`、`plugins/ユーザー選択→文字列1行代入/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment` であること。
- 難読化済みファイル `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente` を直接編集していないこと。
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment` から実行します。
- 難読化済みファイルは `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente` の `contents` 配下を基準に作成します。
...
```text
plugins/ユーザー選択→文字列1行代入/codex/handover-YYYY-MM-DD.md
plugins/ユーザー選択→文字列1行代入/codex/next-tasks.md
```
...
```text
plugins/ユーザー選択→文字列1行代入/decisions/
plugins/ユーザー選択→文字列1行代入/codex/troubleshooting.md
```
