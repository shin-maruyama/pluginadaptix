...
- 対象パス: `plugins/退職者チェック`
- 元ソース: `plugins/退職者チェック/RetirementConversion`
- 難読化済み版: `plugins/退職者チェック/RetirementConversione`
- 解析対象ファイル数: 33
...
- 元ソース優先: plugins/退職者チェック/RetirementConversion
- 難読化済みファイル: plugins/退職者チェック/RetirementConversione（参考情報として扱い、直接修正対象外）
