...
- 対象パス: `plugins/サブテーブル内ユーザー選択人数制限`
- 元ソース: `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit`
- 難読化済み版: `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimite`
- 解析対象ファイル数: 33
...
- 元ソース優先: plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit
- 難読化済みファイル: plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimite（参考情報として扱い、直接修正対象外）
