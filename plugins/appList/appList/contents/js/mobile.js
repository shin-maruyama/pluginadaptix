    ...
    if (listId === event.viewId) {
      ...
      if (radioValue === 'ツリー型') {
        ...
        portalGrid.css({
          ...
          '--portal-title-font-size': Math.max(18, Math.round(portalFontSizes.title * 0.8)) + 'px',
          '--portal-description-font-size': Math.max(14, Math.round(portalFontSizes.description * 0.95)) + 'px',
          '--portal-app-font-size': Math.max(14, Math.round(portalFontSizes.app * 0.94)) + 'px',
          '--portal-subcategory-font-size': Math.max(15, Math.round(portalFontSizes.subcategory * 0.9)) + 'px',
        });
