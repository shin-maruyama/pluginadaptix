...
- 対象パス: `plugins/ふりがな自動入力`
- 元ソース: `plugins/ふりがな自動入力/FuriganaAutoInput`
- 難読化済み版: `plugins/ふりがな自動入力/FuriganaAutoInpute`
- 解析対象ファイル数: 35
- ファイル種別集計: CSS: 8, HTML: 2, JS: 10, JSON: 2, MD: 7, PNG: 2, PUBKEY: 2, SIGNATURE: 2

### 元ソース主要ファイル
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/css/51-modern-default.css`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/css/config.css`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/css/desktop.css`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/css/mobile.css`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/html/config.html`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/image/icon.png`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/js/certification.js`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/js/config.js`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/js/desktop.js`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/js/jquery.autoKana.js`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/js/mobile.js`
- `plugins/ふりがな自動入力/FuriganaAutoInput/contents/manifest.json`
- `plugins/ふりがな自動入力/FuriganaAutoInput/PUBKEY`
- `plugins/ふりがな自動入力/FuriganaAutoInput/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/css/51-modern-default.css`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/css/config.css`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/css/desktop.css`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/css/mobile.css`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/html/config.html`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/image/icon.png`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/js/certification.js.obfuscated.js`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/js/config.js.obfuscated.js`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/js/desktop.js.obfuscated.js`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/js/jquery.autoKana.js.obfuscated.js`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/js/mobile.js.obfuscated.js`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/contents/manifest.json`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/PUBKEY`
- `plugins/ふりがな自動入力/FuriganaAutoInpute/SIGNATURE`

### 保守資料・その他
- `plugins/ふりがな自動入力/codex/handover-2026-06-23.md`
- `plugins/ふりがな自動入力/codex/next-tasks.md`
- `plugins/ふりがな自動入力/codex/test-plan.md`
- `plugins/ふりがな自動入力/codex/troubleshooting.md`
- `plugins/ふりがな自動入力/codex/work-instructions.md`
- `plugins/ふりがな自動入力/decisions/README.md`
- `plugins/ふりがな自動入力/specification.md`
...
- version: 2.0.5
- type: APP
- name.ja: ふりがな自動入力プラグイン_test
- name.en: Plug-in for automatic furigana input
- description.ja: [PluginAdaptiX] v2.0.5 指定した１行文字列フィールドのふりがなを指定した１行文字列フィールドへ格納します。
- icon: image/icon.png
...
- 元ソース優先: plugins/ふりがな自動入力/FuriganaAutoInput
- 難読化済みファイル: plugins/ふりがな自動入力/FuriganaAutoInpute（参考情報として扱い、直接修正対象外）
