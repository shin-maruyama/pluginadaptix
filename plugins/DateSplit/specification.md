...
- 対象プラグイン: `plugins/DateSplit`
- 調査した元ソース: `plugins/DateSplit/DateSplit`
- 難読化済み版: `plugins/DateSplit/DateSplite`
- manifest: `plugins/DateSplit/DateSplit/contents/manifest.json`
- 設定HTML: `plugins/DateSplit/DateSplit/contents/html/config.html`
- JS:
