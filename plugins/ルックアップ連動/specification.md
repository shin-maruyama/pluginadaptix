...
- 対象パス: `plugins/ルックアップ連動`
- 元ソース: `plugins/ルックアップ連動/LookupLinkage`
- 難読化済み版: `plugins/ルックアップ連動/LookupLinkagee`
- 解析対象ファイル数: 33
...
- 元ソース優先: plugins/ルックアップ連動/LookupLinkage
- 難読化済みファイル: plugins/ルックアップ連動/LookupLinkagee（参考情報として扱い、直接修正対象外）
