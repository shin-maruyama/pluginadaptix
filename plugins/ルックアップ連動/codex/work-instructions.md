...
```text
plugins/ルックアップ連動/LookupLinkage
```

## 難読化版場所

```text
plugins/ルックアップ連動/LookupLinkagee
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/ルックアップ連動/LookupLinkage`
- 難読化版: `plugins/ルックアップ連動/LookupLinkagee`
...
1. `plugins/ルックアップ連動/specification.md` を確認する。
2. `plugins/ルックアップ連動/codex/troubleshooting.md`、`plugins/ルックアップ連動/codex/handover-YYYY-MM-DD.md`、`plugins/ルックアップ連動/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/ルックアップ連動/LookupLinkage` であること。
- 難読化済みファイル `plugins/ルックアップ連動/LookupLinkagee` を直接編集していないこと。
- `plugins/ルックアップ連動/LookupLinkage/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/ルックアップ連動/LookupLinkage` から実行します。
- 難読化済みファイルは `plugins/ルックアップ連動/LookupLinkagee` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/ルックアップ連動/LookupLinkage` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/ルックアップ連動/LookupLinkagee` の `contents` 配下を基準に作成します。
...
```text
plugins/ルックアップ連動/codex/handover-YYYY-MM-DD.md
plugins/ルックアップ連動/codex/next-tasks.md
```
