...
- 対象パス: `plugins/CharacterLimit`
- 元ソース: `plugins/CharacterLimit/CharacterLimit`
...
- `plugins/CharacterLimit/CharacterLimit/contents/html/config.html`
- `plugins/CharacterLimit/CharacterLimit/contents/image/icon.png`
...
- `plugins/CharacterLimit/CharacterLimit/contents/manifest.json`
- `plugins/CharacterLimit/CharacterLimit/PUBKEY`
- `plugins/CharacterLimit/CharacterLimit/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/CharacterLimit/CharacterLimite/contents/css/51-modern-default.css`
- `plugins/CharacterLimit/CharacterLimite/contents/css/config.css`
- `plugins/CharacterLimit/CharacterLimite/contents/css/desktop.css`
- `plugins/CharacterLimit/CharacterLimite/contents/css/mobile.css`
- `plugins/CharacterLimit/CharacterLimite/contents/html/config.html`
- `plugins/CharacterLimit/CharacterLimite/contents/image/icon.png`
- `plugins/CharacterLimit/CharacterLimite/contents/js/certification.js.obfuscated.js`
- `plugins/CharacterLimit/CharacterLimite/contents/js/config.js.obfuscated.js`
- `plugins/CharacterLimit/CharacterLimite/contents/js/desktop.js.obfuscated.js`
- `plugins/CharacterLimit/CharacterLimite/contents/js/mobile.js.obfuscated.js`
- `plugins/CharacterLimit/CharacterLimite/contents/manifest.json`
- `plugins/CharacterLimit/CharacterLimite/PUBKEY`
- `plugins/CharacterLimit/CharacterLimite/SIGNATURE`

### 保守資料・その他
- `plugins/CharacterLimit/codex/handover-2026-06-23.md`
- `plugins/CharacterLimit/codex/next-tasks.md`
- `plugins/CharacterLimit/codex/test-plan.md`
- `plugins/CharacterLimit/codex/troubleshooting.md`
- `plugins/CharacterLimit/codex/work-instructions.md`
- `plugins/CharacterLimit/decisions/README.md`
- `plugins/CharacterLimit/specification.md`
...
- 元ソース優先: plugins/CharacterLimit/CharacterLimit
- 難読化済みファイル: plugins/CharacterLimit/CharacterLimite（参考情報として扱い、直接修正対象外）
