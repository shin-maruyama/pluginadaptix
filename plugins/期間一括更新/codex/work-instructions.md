...
```text
plugins/期間一括更新/PeriodBulkUpdate
```

## 難読化版場所

```text
plugins/期間一括更新/PeriodBulkUpdatee
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/期間一括更新/PeriodBulkUpdate`
- 難読化版: `plugins/期間一括更新/PeriodBulkUpdatee`
...
1. `plugins/期間一括更新/specification.md` を確認する。
2. `plugins/期間一括更新/codex/troubleshooting.md`、`plugins/期間一括更新/codex/handover-YYYY-MM-DD.md`、`plugins/期間一括更新/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/期間一括更新/PeriodBulkUpdate` であること。
- 難読化済みファイル `plugins/期間一括更新/PeriodBulkUpdatee` を直接編集していないこと。
- `plugins/期間一括更新/PeriodBulkUpdate/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/期間一括更新/PeriodBulkUpdate` から実行します。
- 難読化済みファイルは `plugins/期間一括更新/PeriodBulkUpdatee` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/期間一括更新/PeriodBulkUpdate` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/期間一括更新/PeriodBulkUpdatee` の `contents` 配下を基準に作成します。
...
```text
plugins/期間一括更新/codex/handover-YYYY-MM-DD.md
plugins/期間一括更新/codex/next-tasks.md
```
