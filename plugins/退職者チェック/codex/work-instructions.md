...
```text
plugins/退職者チェック/RetirementConversion
```

## 難読化版場所

```text
plugins/退職者チェック/RetirementConversione
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/退職者チェック/RetirementConversion`
- 難読化版: `plugins/退職者チェック/RetirementConversione`
...
1. `plugins/退職者チェック/specification.md` を確認する。
2. `plugins/退職者チェック/codex/troubleshooting.md`、`plugins/退職者チェック/codex/handover-YYYY-MM-DD.md`、`plugins/退職者チェック/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/退職者チェック/RetirementConversion` であること。
- 難読化済みファイル `plugins/退職者チェック/RetirementConversione` を直接編集していないこと。
- `plugins/退職者チェック/RetirementConversion/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/退職者チェック/RetirementConversion` から実行します。
- 難読化済みファイルは `plugins/退職者チェック/RetirementConversione` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/退職者チェック/RetirementConversion` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/退職者チェック/RetirementConversione` の `contents` 配下を基準に作成します。
...
```text
plugins/退職者チェック/codex/handover-YYYY-MM-DD.md
plugins/退職者チェック/codex/next-tasks.md
```
