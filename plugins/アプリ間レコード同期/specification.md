...
- 対象パス: `plugins/アプリ間レコード同期`
- 元ソース: `plugins/アプリ間レコード同期/CrossAppRecordSync`
- 難読化済み版: `plugins/アプリ間レコード同期/CrossAppRecordSynce`
- 解析対象ファイル数: 33
- ファイル種別集計: CSS: 8, HTML: 2, JS: 8, JSON: 2, MD: 7, PNG: 2, PUBKEY: 2, SIGNATURE: 2

### 元ソース主要ファイル
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/css/51-modern-default.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/css/config.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/css/desktop.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/css/mobile.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/html/config.html`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/image/icon.png`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/js/certification.js`
...
- `plugins/アプリ間レコード同期/CrossAppRecordSync/contents/manifest.json`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/PUBKEY`
- `plugins/アプリ間レコード同期/CrossAppRecordSync/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/css/51-modern-default.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/css/config.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/css/desktop.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/css/mobile.css`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/html/config.html`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/image/icon.png`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/js/certification.js.obfuscated.js`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/js/config.js.obfuscated.js`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/js/desktop.js.obfuscated.js`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/js/mobile.js.obfuscated.js`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/contents/manifest.json`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/PUBKEY`
- `plugins/アプリ間レコード同期/CrossAppRecordSynce/SIGNATURE`

### 保守資料・その他
- `plugins/アプリ間レコード同期/codex/handover-2026-06-23.md`
- `plugins/アプリ間レコード同期/codex/next-tasks.md`
- `plugins/アプリ間レコード同期/codex/test-plan.md`
- `plugins/アプリ間レコード同期/codex/troubleshooting.md`
- `plugins/アプリ間レコード同期/codex/work-instructions.md`
- `plugins/アプリ間レコード同期/decisions/README.md`
- `plugins/アプリ間レコード同期/specification.md`
...
- 元ソース優先: plugins/アプリ間レコード同期/CrossAppRecordSync
- 難読化済みファイル: plugins/アプリ間レコード同期/CrossAppRecordSynce（参考情報として扱い、直接修正対象外）
