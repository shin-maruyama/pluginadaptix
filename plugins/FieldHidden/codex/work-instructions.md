...
```text
plugins/FieldHidden/FieldHidden
```

## 難読化版場所

```text
plugins/FieldHidden/FieldHiddene
```
...
1. `plugins/FieldHidden/specification.md` を確認する。
2. `plugins/FieldHidden/codex/troubleshooting.md`、`plugins/FieldHidden/codex/handover-YYYY-MM-DD.md`、`plugins/FieldHidden/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/FieldHidden/FieldHidden` であること。
- 難読化済みファイル `plugins/FieldHidden/FieldHiddene` を直接編集していないこと。
- `plugins/FieldHidden/FieldHidden/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/FieldHidden/FieldHidden` から実行します。
- 難読化済みファイルは `plugins/FieldHidden/FieldHiddene` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/FieldHidden/FieldHidden` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/FieldHidden/FieldHiddene` の `contents` 配下を基準に作成します。
...
```text
plugins/FieldHidden/codex/handover-YYYY-MM-DD.md
plugins/FieldHidden/codex/next-tasks.md
```
