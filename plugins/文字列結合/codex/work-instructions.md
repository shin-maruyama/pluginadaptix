...
```text
plugins/文字列結合/StringConcatenatione
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/文字列結合/StringConcatenation`
- 難読化版: `plugins/文字列結合/StringConcatenatione`
...
1. `plugins/文字列結合/specification.md` を確認する。
2. `plugins/文字列結合/codex/troubleshooting.md`、`plugins/文字列結合/codex/handover-YYYY-MM-DD.md`、`plugins/文字列結合/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/文字列結合/StringConcatenation` であること。
- 難読化済みファイル `plugins/文字列結合/StringConcatenatione` を直接編集していないこと。
- `plugins/文字列結合/StringConcatenation/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/文字列結合/StringConcatenation` から実行します。
- 難読化済みファイルは `plugins/文字列結合/StringConcatenatione` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/文字列結合/StringConcatenation` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/文字列結合/StringConcatenatione` の `contents` 配下を基準に作成します。
...
```text
plugins/文字列結合/codex/handover-YYYY-MM-DD.md
plugins/文字列結合/codex/next-tasks.md
```
