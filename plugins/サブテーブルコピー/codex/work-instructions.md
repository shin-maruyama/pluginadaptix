...
```text
plugins/サブテーブルコピー/SubtableCopy
```

## 難読化版場所

```text
plugins/サブテーブルコピー/SubtableCopye
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/サブテーブルコピー/SubtableCopy`
- 難読化版: `plugins/サブテーブルコピー/SubtableCopye`
...
1. `plugins/サブテーブルコピー/specification.md` を確認する。
2. `plugins/サブテーブルコピー/codex/troubleshooting.md`、`plugins/サブテーブルコピー/codex/handover-YYYY-MM-DD.md`、`plugins/サブテーブルコピー/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/サブテーブルコピー/SubtableCopy` であること。
- 難読化済みファイル `plugins/サブテーブルコピー/SubtableCopye` を直接編集していないこと。
- `plugins/サブテーブルコピー/SubtableCopy/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/サブテーブルコピー/SubtableCopy` から実行します。
- 難読化済みファイルは `plugins/サブテーブルコピー/SubtableCopye` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/サブテーブルコピー/SubtableCopy` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/サブテーブルコピー/SubtableCopye` の `contents` 配下を基準に作成します。
...
```text
plugins/サブテーブルコピー/codex/handover-YYYY-MM-DD.md
plugins/サブテーブルコピー/codex/next-tasks.md
```
