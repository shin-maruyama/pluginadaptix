...
- 対象パス: `plugins/サブテーブルコピー`
- 元ソース: `plugins/サブテーブルコピー/SubtableCopy`
- 難読化済み版: `plugins/サブテーブルコピー/SubtableCopye`
- 解析対象ファイル数: 33
- ファイル種別集計: CSS: 8, HTML: 2, JS: 8, JSON: 2, MD: 7, PNG: 2, PUBKEY: 2, SIGNATURE: 2

### 元ソース主要ファイル
- `plugins/サブテーブルコピー/SubtableCopy/contents/css/51-modern-default.css`
- `plugins/サブテーブルコピー/SubtableCopy/contents/css/config.css`
- `plugins/サブテーブルコピー/SubtableCopy/contents/css/desktop.css`
- `plugins/サブテーブルコピー/SubtableCopy/contents/css/mobile.css`
- `plugins/サブテーブルコピー/SubtableCopy/contents/html/config.html`
- `plugins/サブテーブルコピー/SubtableCopy/contents/image/icon.png`
- `plugins/サブテーブルコピー/SubtableCopy/contents/js/certification.js`
...
- `plugins/サブテーブルコピー/SubtableCopy/contents/manifest.json`
- `plugins/サブテーブルコピー/SubtableCopy/PUBKEY`
- `plugins/サブテーブルコピー/SubtableCopy/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/サブテーブルコピー/SubtableCopye/contents/css/51-modern-default.css`
- `plugins/サブテーブルコピー/SubtableCopye/contents/css/config.css`
- `plugins/サブテーブルコピー/SubtableCopye/contents/css/desktop.css`
- `plugins/サブテーブルコピー/SubtableCopye/contents/css/mobile.css`
- `plugins/サブテーブルコピー/SubtableCopye/contents/html/config.html`
- `plugins/サブテーブルコピー/SubtableCopye/contents/image/icon.png`
- `plugins/サブテーブルコピー/SubtableCopye/contents/js/certification.js.obfuscated.js`
- `plugins/サブテーブルコピー/SubtableCopye/contents/js/config.js.obfuscated.js`
- `plugins/サブテーブルコピー/SubtableCopye/contents/js/desktop.js.obfuscated.js`
- `plugins/サブテーブルコピー/SubtableCopye/contents/js/mobile.js.obfuscated.js`
- `plugins/サブテーブルコピー/SubtableCopye/contents/manifest.json`
- `plugins/サブテーブルコピー/SubtableCopye/PUBKEY`
- `plugins/サブテーブルコピー/SubtableCopye/SIGNATURE`

### 保守資料・その他
- `plugins/サブテーブルコピー/codex/handover-2026-06-23.md`
- `plugins/サブテーブルコピー/codex/next-tasks.md`
- `plugins/サブテーブルコピー/codex/test-plan.md`
- `plugins/サブテーブルコピー/codex/troubleshooting.md`
- `plugins/サブテーブルコピー/codex/work-instructions.md`
- `plugins/サブテーブルコピー/decisions/README.md`
- `plugins/サブテーブルコピー/specification.md`
...
- 元ソース優先: plugins/サブテーブルコピー/SubtableCopy
- 難読化済みファイル: plugins/サブテーブルコピー/SubtableCopye（参考情報として扱い、直接修正対象外）
