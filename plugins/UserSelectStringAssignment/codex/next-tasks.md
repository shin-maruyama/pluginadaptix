# UserSelectStringAssignment 次回作業予定
...
6. ZIPを作成する場合は、通常版 `UserSelectStringAssignment-v<version>.zip` と難読化版 `UserSelectStringAssignment-ev<version>.zip` の作成要否を記録する。
