...
- 対象パス: `plugins/UserSelectStringAssignment`
...
- `plugins/UserSelectStringAssignment/UserSelectStringAssignment/contents/html/config.html`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignment/contents/image/icon.png`
...
- `plugins/UserSelectStringAssignment/UserSelectStringAssignment/contents/manifest.json`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignment/PUBKEY`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignment/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/css/51-modern-default.css`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/css/config.css`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/css/desktop.css`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/css/mobile.css`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/html/config.html`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/image/icon.png`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/js/certification.js.obfuscated.js`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/js/config.js.obfuscated.js`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/js/desktop.js.obfuscated.js`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/js/mobile.js.obfuscated.js`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/contents/manifest.json`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/PUBKEY`
- `plugins/UserSelectStringAssignment/UserSelectStringAssignmente/SIGNATURE`
...
- 元ソース優先: plugins/UserSelectStringAssignment/UserSelectStringAssignment
- 難読化済みファイル: plugins/UserSelectStringAssignment/UserSelectStringAssignmente（参考情報として扱い、直接修正対象外）
