...
```text
plugins/LookupLinkage/LookupLinkage
```

## 難読化版場所

```text
plugins/LookupLinkage/LookupLinkagee
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/LookupLinkage/LookupLinkage`
- 難読化版: `plugins/LookupLinkage/LookupLinkagee`
...
1. `plugins/LookupLinkage/specification.md` を確認する。
2. `plugins/LookupLinkage/codex/troubleshooting.md`、`plugins/LookupLinkage/codex/handover-YYYY-MM-DD.md`、`plugins/LookupLinkage/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/LookupLinkage/LookupLinkage` であること。
- 難読化済みファイル `plugins/LookupLinkage/LookupLinkagee` を直接編集していないこと。
- `plugins/LookupLinkage/LookupLinkage/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/LookupLinkage/LookupLinkage` から実行します。
- 難読化済みファイルは `plugins/LookupLinkage/LookupLinkagee` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/LookupLinkage/LookupLinkage` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/LookupLinkage/LookupLinkagee` の `contents` 配下を基準に作成します。
...
```text
plugins/LookupLinkage/codex/handover-YYYY-MM-DD.md
plugins/LookupLinkage/codex/next-tasks.md
```
...
```text
LookupLinkage-v<version>.zip
```

難読化版ZIP:

```text
LookupLinkage-ev<version>.zip
```
...
```text
plugins/LookupLinkage/decisions/
plugins/LookupLinkage/codex/troubleshooting.md
```
