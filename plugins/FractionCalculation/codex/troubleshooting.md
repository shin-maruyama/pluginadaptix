...
## 2026-26-06 BUG ID: BUG-009

### 発生事象

mobile.jsの設定済みフィールド確認でdesktop APIのgetIdを使用している

### 原因

mobile.jsでdesktop APIの `kintone.app.getId()` を使用していた。

### 修正内容

モバイル画面のフォームレイアウト取得で `kintone.mobile.app.getId()` を使用するよう修正しました。
...
## 2026-06-26 Medium BUG ID: PB-0030
...
## 2026-06-26 Medium BUG ID: PB-0031
...
## 2026-06-26 Medium BUG ID: PB-0032
...
## 2026-06-26 Medium BUG ID: PB-0033
