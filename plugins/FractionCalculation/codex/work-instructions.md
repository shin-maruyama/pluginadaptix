# FractionCalculation Codex作業指示書
...
```text
plugins/FractionCalculation/FractionCalculatione
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/FractionCalculation/FractionCalculation`
- 難読化版: `plugins/FractionCalculation/FractionCalculatione`
...
1. `plugins/FractionCalculation/specification.md` を確認する。
2. `plugins/FractionCalculation/codex/troubleshooting.md`、`plugins/FractionCalculation/codex/handover-YYYY-MM-DD.md`、`plugins/FractionCalculation/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/FractionCalculation/FractionCalculation` であること。
- 難読化済みファイル `plugins/FractionCalculation/FractionCalculatione` を直接編集していないこと。
- `plugins/FractionCalculation/FractionCalculation/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/FractionCalculation/FractionCalculation` から実行します。
- 難読化済みファイルは `plugins/FractionCalculation/FractionCalculatione` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/FractionCalculation/FractionCalculation` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/FractionCalculation/FractionCalculatione` の `contents` 配下を基準に作成します。
...
```text
plugins/FractionCalculation/codex/handover-YYYY-MM-DD.md
plugins/FractionCalculation/codex/next-tasks.md
```
...
```text
FractionCalculation-v<version>.zip
```

難読化版ZIP:

```text
FractionCalculation-ev<version>.zip
```
...
```text
plugins/FractionCalculation/decisions/
plugins/FractionCalculation/codex/troubleshooting.md
```
