...
- 対象プラグイン: `plugins/FractionCalculation`
- 調査した元ソース: `plugins/FractionCalculation/FractionCalculation`
- 難読化済み版: `plugins/FractionCalculation/FractionCalculatione`
- manifest: `plugins/FractionCalculation/FractionCalculation/contents/manifest.json`
- 設定HTML: `plugins/FractionCalculation/FractionCalculation/contents/html/config.html`
- JS:
