...
- 対象パス: `plugins/FractionCalculation`
...
- 元ソース優先: plugins/FractionCalculation/FractionCalculation
- 難読化済みファイル: plugins/FractionCalculation/FractionCalculatione（参考情報として扱い、直接修正対象外）
