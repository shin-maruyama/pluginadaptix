...
- 対象パス: `plugins/FuriganaAutoInput`
- 元ソース: `plugins/FuriganaAutoInput/FuriganaAutoInput`
...
- `plugins/FuriganaAutoInput/FuriganaAutoInput/contents/html/config.html`
- `plugins/FuriganaAutoInput/FuriganaAutoInput/contents/image/icon.png`
...
- `plugins/FuriganaAutoInput/FuriganaAutoInput/contents/manifest.json`
- `plugins/FuriganaAutoInput/FuriganaAutoInput/PUBKEY`
- `plugins/FuriganaAutoInput/FuriganaAutoInput/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/css/51-modern-default.css`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/css/config.css`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/css/desktop.css`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/css/mobile.css`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/html/config.html`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/image/icon.png`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/js/certification.js.obfuscated.js`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/js/config.js.obfuscated.js`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/js/desktop.js.obfuscated.js`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/js/jquery.autoKana.js.obfuscated.js`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/js/mobile.js.obfuscated.js`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/contents/manifest.json`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/PUBKEY`
- `plugins/FuriganaAutoInput/FuriganaAutoInpute/SIGNATURE`

### 保守資料・その他
- `plugins/FuriganaAutoInput/codex/handover-2026-06-23.md`
- `plugins/FuriganaAutoInput/codex/next-tasks.md`
- `plugins/FuriganaAutoInput/codex/test-plan.md`
- `plugins/FuriganaAutoInput/codex/troubleshooting.md`
- `plugins/FuriganaAutoInput/codex/work-instructions.md`
- `plugins/FuriganaAutoInput/decisions/README.md`
- `plugins/FuriganaAutoInput/specification.md`
...
- 元ソース優先: plugins/FuriganaAutoInput/FuriganaAutoInput
- 難読化済みファイル: plugins/FuriganaAutoInput/FuriganaAutoInpute（参考情報として扱い、直接修正対象外）
