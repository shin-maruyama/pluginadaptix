...
```text
plugins/CrossAppRecordSync/CrossAppRecordSynce
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/CrossAppRecordSync/CrossAppRecordSync`
- 難読化版: `plugins/CrossAppRecordSync/CrossAppRecordSynce`
...
1. `plugins/CrossAppRecordSync/specification.md` を確認する。
2. `plugins/CrossAppRecordSync/codex/troubleshooting.md`、`plugins/CrossAppRecordSync/codex/handover-YYYY-MM-DD.md`、`plugins/CrossAppRecordSync/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/CrossAppRecordSync/CrossAppRecordSync` であること。
- 難読化済みファイル `plugins/CrossAppRecordSync/CrossAppRecordSynce` を直接編集していないこと。
- `plugins/CrossAppRecordSync/CrossAppRecordSync/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/CrossAppRecordSync/CrossAppRecordSync` から実行します。
- 難読化済みファイルは `plugins/CrossAppRecordSync/CrossAppRecordSynce` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/CrossAppRecordSync/CrossAppRecordSync` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/CrossAppRecordSync/CrossAppRecordSynce` の `contents` 配下を基準に作成します。
...
```text
plugins/CrossAppRecordSync/codex/handover-YYYY-MM-DD.md
plugins/CrossAppRecordSync/codex/next-tasks.md
```
...
```text
plugins/CrossAppRecordSync/decisions/
plugins/CrossAppRecordSync/codex/troubleshooting.md
```
