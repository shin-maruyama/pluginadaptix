...
- `plugins/TimeCalculation/TimeCalculation/contents/html/config.html`
- `plugins/TimeCalculation/TimeCalculation/contents/image/icon.png`
...
- `plugins/TimeCalculation/TimeCalculation/contents/manifest.json`
- `plugins/TimeCalculation/TimeCalculation/PUBKEY`
- `plugins/TimeCalculation/TimeCalculation/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/TimeCalculation/TimeCalculatione/contents/css/51-modern-default.css`
- `plugins/TimeCalculation/TimeCalculatione/contents/css/config.css`
- `plugins/TimeCalculation/TimeCalculatione/contents/css/desktop.css`
- `plugins/TimeCalculation/TimeCalculatione/contents/css/mobile.css`
- `plugins/TimeCalculation/TimeCalculatione/contents/html/config.html`
- `plugins/TimeCalculation/TimeCalculatione/contents/image/icon.png`
- `plugins/TimeCalculation/TimeCalculatione/contents/js/certification.js.obfuscated.js`
- `plugins/TimeCalculation/TimeCalculatione/contents/js/config.js.obfuscated.js`
- `plugins/TimeCalculation/TimeCalculatione/contents/js/desktop.js.obfuscated.js`
- `plugins/TimeCalculation/TimeCalculatione/contents/js/mobile.js.obfuscated.js`
- `plugins/TimeCalculation/TimeCalculatione/contents/manifest.json`
- `plugins/TimeCalculation/TimeCalculatione/PUBKEY`
- `plugins/TimeCalculation/TimeCalculatione/SIGNATURE`

### 保守資料・その他
- `plugins/TimeCalculation/codex/handover-2026-06-23.md`
- `plugins/TimeCalculation/codex/next-tasks.md`
- `plugins/TimeCalculation/codex/test-plan.md`
- `plugins/TimeCalculation/codex/troubleshooting.md`
- `plugins/TimeCalculation/codex/work-instructions.md`
- `plugins/TimeCalculation/decisions/README.md`
- `plugins/TimeCalculation/specification.md`
...
- 元ソース優先: plugins/TimeCalculation/TimeCalculation
- 難読化済みファイル: plugins/TimeCalculation/TimeCalculatione（参考情報として扱い、直接修正対象外）
