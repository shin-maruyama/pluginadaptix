...
1. `plugins/TimeCalculation/specification.md` を確認する。
2. `plugins/TimeCalculation/codex/troubleshooting.md`、`plugins/TimeCalculation/codex/handover-YYYY-MM-DD.md`、`plugins/TimeCalculation/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/TimeCalculation/TimeCalculation` であること。
- 難読化済みファイル `plugins/TimeCalculation/TimeCalculatione` を直接編集していないこと。
- `plugins/TimeCalculation/TimeCalculation/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/TimeCalculation/TimeCalculation` から実行します。
- 難読化済みファイルは `plugins/TimeCalculation/TimeCalculatione` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/TimeCalculation/TimeCalculation` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/TimeCalculation/TimeCalculatione` の `contents` 配下を基準に作成します。
...
```text
plugins/TimeCalculation/codex/handover-YYYY-MM-DD.md
plugins/TimeCalculation/codex/next-tasks.md
```
...
```text
TimeCalculation-v<version>.zip
```

難読化版ZIP:

```text
TimeCalculation-ev<version>.zip
```
...
```text
plugins/TimeCalculation/decisions/
plugins/TimeCalculation/codex/troubleshooting.md
```
