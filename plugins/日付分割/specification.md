...
- 対象パス: `plugins/日付分割`
- 元ソース: `plugins/日付分割/DateSplit`
- 難読化済み版: `plugins/日付分割/DateSplite`
- 解析対象ファイル数: 33
- ファイル種別集計: CSS: 8, HTML: 2, JS: 8, JSON: 2, MD: 7, PNG: 2, PUBKEY: 2, SIGNATURE: 2

### 元ソース主要ファイル
- `plugins/日付分割/DateSplit/contents/css/51-modern-default.css`
- `plugins/日付分割/DateSplit/contents/css/config.css`
- `plugins/日付分割/DateSplit/contents/css/desktop.css`
- `plugins/日付分割/DateSplit/contents/css/mobile.css`
- `plugins/日付分割/DateSplit/contents/html/config.html`
- `plugins/日付分割/DateSplit/contents/image/icon.png`
- `plugins/日付分割/DateSplit/contents/js/certification.js`
...
- `plugins/日付分割/DateSplit/contents/manifest.json`
- `plugins/日付分割/DateSplit/PUBKEY`
- `plugins/日付分割/DateSplit/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/日付分割/DateSplite/contents/css/51-modern-default.css`
- `plugins/日付分割/DateSplite/contents/css/config.css`
- `plugins/日付分割/DateSplite/contents/css/desktop.css`
- `plugins/日付分割/DateSplite/contents/css/mobile.css`
- `plugins/日付分割/DateSplite/contents/html/config.html`
- `plugins/日付分割/DateSplite/contents/image/icon.png`
- `plugins/日付分割/DateSplite/contents/js/certification.js.obfuscated.js`
- `plugins/日付分割/DateSplite/contents/js/config.js.obfuscated.js`
- `plugins/日付分割/DateSplite/contents/js/desktop.js.obfuscated.js`
- `plugins/日付分割/DateSplite/contents/js/mobile.js.obfuscated.js`
- `plugins/日付分割/DateSplite/contents/manifest.json`
- `plugins/日付分割/DateSplite/PUBKEY`
- `plugins/日付分割/DateSplite/SIGNATURE`

### 保守資料・その他
- `plugins/日付分割/codex/handover-2026-06-23.md`
- `plugins/日付分割/codex/next-tasks.md`
- `plugins/日付分割/codex/test-plan.md`
- `plugins/日付分割/codex/troubleshooting.md`
- `plugins/日付分割/codex/work-instructions.md`
- `plugins/日付分割/decisions/README.md`
- `plugins/日付分割/specification.md`
...
- 元ソース優先: plugins/日付分割/DateSplit
- 難読化済みファイル: plugins/日付分割/DateSplite（参考情報として扱い、直接修正対象外）
