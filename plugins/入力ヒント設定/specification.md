...
- 対象パス: `plugins/入力ヒント設定`
- 元ソース: `plugins/入力ヒント設定/InputHintSetting`
- 難読化済み版: `plugins/入力ヒント設定/InputHintSettinge`
- 解析対象ファイル数: 33
...
- 元ソース優先: plugins/入力ヒント設定/InputHintSetting
- 難読化済みファイル: plugins/入力ヒント設定/InputHintSettinge（参考情報として扱い、直接修正対象外）
