...
```text
plugins/入力ヒント設定/InputHintSetting
```

## 難読化版場所

```text
plugins/入力ヒント設定/InputHintSettinge
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/入力ヒント設定/InputHintSetting`
- 難読化版: `plugins/入力ヒント設定/InputHintSettinge`
...
1. `plugins/入力ヒント設定/specification.md` を確認する。
2. `plugins/入力ヒント設定/codex/troubleshooting.md`、`plugins/入力ヒント設定/codex/handover-YYYY-MM-DD.md`、`plugins/入力ヒント設定/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/入力ヒント設定/InputHintSetting` であること。
- 難読化済みファイル `plugins/入力ヒント設定/InputHintSettinge` を直接編集していないこと。
- `plugins/入力ヒント設定/InputHintSetting/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/入力ヒント設定/InputHintSetting` から実行します。
- 難読化済みファイルは `plugins/入力ヒント設定/InputHintSettinge` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/入力ヒント設定/InputHintSetting` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/入力ヒント設定/InputHintSettinge` の `contents` 配下を基準に作成します。
...
```text
plugins/入力ヒント設定/codex/handover-YYYY-MM-DD.md
plugins/入力ヒント設定/codex/next-tasks.md
```
