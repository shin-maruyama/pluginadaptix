...
```text
plugins/TAB表示/TabDisplay
```

## 難読化版場所

```text
plugins/TAB表示/TabDisplaye
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/TAB表示/TabDisplay`
- 難読化版: `plugins/TAB表示/TabDisplaye`
...
1. `plugins/TAB表示/specification.md` を確認する。
2. `plugins/TAB表示/codex/troubleshooting.md`、`plugins/TAB表示/codex/handover-YYYY-MM-DD.md`、`plugins/TAB表示/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/TAB表示/TabDisplay` であること。
- 難読化済みファイル `plugins/TAB表示/TabDisplaye` を直接編集していないこと。
- `plugins/TAB表示/TabDisplay/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/TAB表示/TabDisplay` から実行します。
- 難読化済みファイルは `plugins/TAB表示/TabDisplaye` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/TAB表示/TabDisplay` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/TAB表示/TabDisplaye` の `contents` 配下を基準に作成します。
...
```text
plugins/TAB表示/codex/handover-YYYY-MM-DD.md
plugins/TAB表示/codex/next-tasks.md
```
