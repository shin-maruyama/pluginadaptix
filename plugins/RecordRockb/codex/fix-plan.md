# RecordRockb バグ修正準備計画

作業日: 2026-06-26

## 1. 修正対象バグ

- BUG-025: No.1 2026-24-06 BUG-025 ブラウザ終了/戻る操作時にロック解除されない可能性がある

## 2. 優先順位

1. BUG-025: 重大度 Medium、確度 要確認
...
- BUG-025: recordLock.eventStart（20行付近）

## 5. 修正方針

- BUG-025: 仕様として許容するか、人間判断が必要。解除期限や強制解除運用を検討する。

## 6. 影響範囲

- BUG-025: 中 - ロック用ユーザー選択フィールドに値が残り、他ユーザーが編集できない状態になる可能性がある。
