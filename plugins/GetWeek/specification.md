...
- 対象パス: `plugins/GetWeek`
- 元ソース: `plugins/GetWeek/GetWeek`
...
- `plugins/GetWeek/GetWeek/contents/html/config.html`
- `plugins/GetWeek/GetWeek/contents/image/icon.png`
...
- `plugins/GetWeek/GetWeek/contents/manifest.json`
- `plugins/GetWeek/GetWeek/PUBKEY`
- `plugins/GetWeek/GetWeek/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/GetWeek/GetWeeke/contents/css/51-modern-default.css`
- `plugins/GetWeek/GetWeeke/contents/css/config.css`
- `plugins/GetWeek/GetWeeke/contents/css/desktop.css`
- `plugins/GetWeek/GetWeeke/contents/css/mobile.css`
- `plugins/GetWeek/GetWeeke/contents/html/config.html`
- `plugins/GetWeek/GetWeeke/contents/image/icon.png`
- `plugins/GetWeek/GetWeeke/contents/js/certification.js.obfuscated.js`
- `plugins/GetWeek/GetWeeke/contents/js/config.js.obfuscated.js`
- `plugins/GetWeek/GetWeeke/contents/js/desktop.js.obfuscated.js`
- `plugins/GetWeek/GetWeeke/contents/js/mobile.js.obfuscated.js`
- `plugins/GetWeek/GetWeeke/contents/manifest.json`
- `plugins/GetWeek/GetWeeke/PUBKEY`
- `plugins/GetWeek/GetWeeke/SIGNATURE`

### 保守資料・その他
- `plugins/GetWeek/codex/handover-2026-06-23.md`
- `plugins/GetWeek/codex/next-tasks.md`
- `plugins/GetWeek/codex/test-plan.md`
- `plugins/GetWeek/codex/troubleshooting.md`
- `plugins/GetWeek/codex/work-instructions.md`
- `plugins/GetWeek/decisions/README.md`
- `plugins/GetWeek/specification.md`
...
- 元ソース優先: plugins/GetWeek/GetWeek
- 難読化済みファイル: plugins/GetWeek/GetWeeke（参考情報として扱い、直接修正対象外）
