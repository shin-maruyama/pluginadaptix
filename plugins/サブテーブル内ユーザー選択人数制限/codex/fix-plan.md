# SubTableUserLimit バグ修正準備計画

作業日: 2026-06-26

## 1. 修正対象バグ

- BUG-028: No.1 2026-24-06 BUG-028 設定画面にデバッグログが残っている

## 2. 優先順位

1. BUG-028: 重大度 Low、確度 高確度
...
- BUG-028: limit.numberFieldValueCheck（423行付近）
...
- BUG-028: 未確認 - 機能影響は小さいが、運用時のコンソールノイズになる。
