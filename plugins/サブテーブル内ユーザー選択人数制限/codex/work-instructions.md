...
```text
plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit
```

## 難読化版場所

```text
plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimite
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit`
- 難読化版: `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimite`
...
1. `plugins/サブテーブル内ユーザー選択人数制限/specification.md` を確認する。
2. `plugins/サブテーブル内ユーザー選択人数制限/codex/troubleshooting.md`、`plugins/サブテーブル内ユーザー選択人数制限/codex/handover-YYYY-MM-DD.md`、`plugins/サブテーブル内ユーザー選択人数制限/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit` であること。
- 難読化済みファイル `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimite` を直接編集していないこと。
- `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit` から実行します。
- 難読化済みファイルは `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimite` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimit` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/サブテーブル内ユーザー選択人数制限/SubTableUserLimite` の `contents` 配下を基準に作成します。
...
```text
plugins/サブテーブル内ユーザー選択人数制限/codex/handover-YYYY-MM-DD.md
plugins/サブテーブル内ユーザー選択人数制限/codex/next-tasks.md
```
...
```text
SubTableUserLimit-v<version>.zip
```

難読化版ZIP:

```text
SubTableUserLimit-ev<version>.zip
```
...
```text
plugins/サブテーブル内ユーザー選択人数制限/decisions/
plugins/サブテーブル内ユーザー選択人数制限/codex/troubleshooting.md
```
