...
- 対象パス: `plugins/サブテーブル自動ソート`
- 元ソース: `plugins/サブテーブル自動ソート/SubTableAutosort`
- 難読化済み版: `plugins/サブテーブル自動ソート/SubTableAutosorte`
- 解析対象ファイル数: 33
...
- 元ソース優先: plugins/サブテーブル自動ソート/SubTableAutosort
- 難読化済みファイル: plugins/サブテーブル自動ソート/SubTableAutosorte（参考情報として扱い、直接修正対象外）
