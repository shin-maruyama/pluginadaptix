...
```text
plugins/PeriodBulkUpdate/PeriodBulkUpdate
```

## 難読化版場所

```text
plugins/PeriodBulkUpdate/PeriodBulkUpdatee
```
...
1. `plugins/PeriodBulkUpdate/specification.md` を確認する。
2. `plugins/PeriodBulkUpdate/codex/troubleshooting.md`、`plugins/PeriodBulkUpdate/codex/handover-YYYY-MM-DD.md`、`plugins/PeriodBulkUpdate/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/PeriodBulkUpdate/PeriodBulkUpdate` であること。
- 難読化済みファイル `plugins/PeriodBulkUpdate/PeriodBulkUpdatee` を直接編集していないこと。
- `plugins/PeriodBulkUpdate/PeriodBulkUpdate/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/PeriodBulkUpdate/PeriodBulkUpdate` から実行します。
- 難読化済みファイルは `plugins/PeriodBulkUpdate/PeriodBulkUpdatee` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/PeriodBulkUpdate/PeriodBulkUpdate` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/PeriodBulkUpdate/PeriodBulkUpdatee` の `contents` 配下を基準に作成します。
...
```text
plugins/PeriodBulkUpdate/codex/handover-YYYY-MM-DD.md
plugins/PeriodBulkUpdate/codex/next-tasks.md
```
...
```text
PeriodBulkUpdate-v<version>.zip
```

難読化版ZIP:

```text
PeriodBulkUpdate-ev<version>.zip
```
...
```text
plugins/PeriodBulkUpdate/decisions/
plugins/PeriodBulkUpdate/codex/troubleshooting.md
```
