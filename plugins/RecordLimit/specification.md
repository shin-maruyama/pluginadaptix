...
- `plugins/RecordLimit/RecordLimit/contents/html/config.html`
- `plugins/RecordLimit/RecordLimit/contents/image/icon.png`
...
- `plugins/RecordLimit/RecordLimit/contents/manifest.json`
- `plugins/RecordLimit/RecordLimit/PUBKEY`
- `plugins/RecordLimit/RecordLimit/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/RecordLimit/RecordLimite/contents/css/51-modern-default.css`
- `plugins/RecordLimit/RecordLimite/contents/css/config.css`
- `plugins/RecordLimit/RecordLimite/contents/css/desktop.css`
- `plugins/RecordLimit/RecordLimite/contents/css/mobile.css`
- `plugins/RecordLimit/RecordLimite/contents/html/config.html`
- `plugins/RecordLimit/RecordLimite/contents/image/icon.png`
- `plugins/RecordLimit/RecordLimite/contents/js/certification.obfuscated.js`
- `plugins/RecordLimit/RecordLimite/contents/js/config.obfuscated.js`
- `plugins/RecordLimit/RecordLimite/contents/js/desktop.obfuscated.js`
- `plugins/RecordLimit/RecordLimite/contents/js/mobile.obfuscated.js`
- `plugins/RecordLimit/RecordLimite/contents/manifest.json`
- `plugins/RecordLimit/RecordLimite/PUBKEY`
- `plugins/RecordLimit/RecordLimite/SIGNATURE`

### 保守資料・その他
- `plugins/RecordLimit/codex/handover-2026-06-23.md`
- `plugins/RecordLimit/codex/next-tasks.md`
- `plugins/RecordLimit/codex/test-plan.md`
- `plugins/RecordLimit/codex/troubleshooting.md`
- `plugins/RecordLimit/codex/work-instructions.md`
- `plugins/RecordLimit/decisions/README.md`
- `plugins/RecordLimit/specification.md`
...
- 元ソース優先: plugins/RecordLimit/RecordLimit
- 難読化済みファイル: plugins/RecordLimit/RecordLimite（参考情報として扱い、直接修正対象外）
