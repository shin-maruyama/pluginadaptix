...
```text
plugins/レコードロック確認/RecordRockb
```

## 難読化版場所

```text
plugins/レコードロック確認/RecordRockbe
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/レコードロック確認/RecordRockb`
- 難読化版: `plugins/レコードロック確認/RecordRockbe`
...
1. `plugins/レコードロック確認/specification.md` を確認する。
2. `plugins/レコードロック確認/codex/troubleshooting.md`、`plugins/レコードロック確認/codex/handover-YYYY-MM-DD.md`、`plugins/レコードロック確認/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/レコードロック確認/RecordRockb` であること。
- 難読化済みファイル `plugins/レコードロック確認/RecordRockbe` を直接編集していないこと。
- `plugins/レコードロック確認/RecordRockb/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/レコードロック確認/RecordRockb` から実行します。
- 難読化済みファイルは `plugins/レコードロック確認/RecordRockbe` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/レコードロック確認/RecordRockb` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/レコードロック確認/RecordRockbe` の `contents` 配下を基準に作成します。
...
```text
plugins/レコードロック確認/codex/handover-YYYY-MM-DD.md
plugins/レコードロック確認/codex/next-tasks.md
```
