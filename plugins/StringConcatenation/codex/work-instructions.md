# StringConcatenation Codex作業指示書
...
```text
plugins/StringConcatenation/StringConcatenatione
```
...
1. `plugins/StringConcatenation/specification.md` を確認する。
2. `plugins/StringConcatenation/codex/troubleshooting.md`、`plugins/StringConcatenation/codex/handover-YYYY-MM-DD.md`、`plugins/StringConcatenation/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/StringConcatenation/StringConcatenation` であること。
- 難読化済みファイル `plugins/StringConcatenation/StringConcatenatione` を直接編集していないこと。
- `plugins/StringConcatenation/StringConcatenation/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/StringConcatenation/StringConcatenation` から実行します。
- 難読化済みファイルは `plugins/StringConcatenation/StringConcatenatione` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/StringConcatenation/StringConcatenation` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/StringConcatenation/StringConcatenatione` の `contents` 配下を基準に作成します。
...
```text
StringConcatenation-v<version>.zip
```

難読化版ZIP:

```text
StringConcatenation-ev<version>.zip
```
