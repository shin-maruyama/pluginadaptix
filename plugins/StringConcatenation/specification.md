...
- 対象プラグイン: `plugins/StringConcatenation`
- 調査した元ソース: `plugins/StringConcatenation/StringConcatenation`
- 難読化済み版: `plugins/StringConcatenation/StringConcatenatione`
- manifest: `plugins/StringConcatenation/StringConcatenation/contents/manifest.json`
- 設定HTML: `plugins/StringConcatenation/StringConcatenation/contents/html/config.html`
- JS:
