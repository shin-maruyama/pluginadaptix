...
```text
plugins/InputHintSetting
```

## 元ソース場所

```text
plugins/InputHintSetting/InputHintSetting
```

## 難読化版場所

```text
plugins/InputHintSetting/InputHintSettinge
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/InputHintSetting/InputHintSetting`
- 難読化版: `plugins/InputHintSetting/InputHintSettinge`
...
1. `plugins/InputHintSetting/specification.md` を確認する。
2. `plugins/InputHintSetting/codex/troubleshooting.md`、`plugins/InputHintSetting/codex/handover-YYYY-MM-DD.md`、`plugins/InputHintSetting/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/InputHintSetting/InputHintSetting` であること。
- 難読化済みファイル `plugins/InputHintSetting/InputHintSettinge` を直接編集していないこと。
- `plugins/InputHintSetting/InputHintSetting/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/InputHintSetting/InputHintSetting` から実行します。
- 難読化済みファイルは `plugins/InputHintSetting/InputHintSettinge` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/InputHintSetting/InputHintSetting` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/InputHintSetting/InputHintSettinge` の `contents` 配下を基準に作成します。
...
```text
plugins/InputHintSetting/codex/handover-YYYY-MM-DD.md
plugins/InputHintSetting/codex/next-tasks.md
```
...
```text
InputHintSetting-v<version>.zip
```

難読化版ZIP:

```text
InputHintSetting-ev<version>.zip
```
...
```text
plugins/InputHintSetting/decisions/
plugins/InputHintSetting/codex/troubleshooting.md
```
