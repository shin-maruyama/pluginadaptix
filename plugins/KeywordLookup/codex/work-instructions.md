...
```text
plugins/KeywordLookup/KeywordLookupe
```
...
1. `plugins/KeywordLookup/specification.md` を確認する。
2. `plugins/KeywordLookup/codex/troubleshooting.md`、`plugins/KeywordLookup/codex/handover-YYYY-MM-DD.md`、`plugins/KeywordLookup/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/KeywordLookup/KeywordLookup` であること。
- 難読化済みファイル `plugins/KeywordLookup/KeywordLookupe` を直接編集していないこと。
- `plugins/KeywordLookup/KeywordLookup/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/KeywordLookup/KeywordLookup` から実行します。
- 難読化済みファイルは `plugins/KeywordLookup/KeywordLookupe` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/KeywordLookup/KeywordLookup` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/KeywordLookup/KeywordLookupe` の `contents` 配下を基準に作成します。
...
```text
plugins/KeywordLookup/codex/handover-YYYY-MM-DD.md
plugins/KeywordLookup/codex/next-tasks.md
```
...
```text
plugins/KeywordLookup/decisions/
plugins/KeywordLookup/codex/troubleshooting.md
```
