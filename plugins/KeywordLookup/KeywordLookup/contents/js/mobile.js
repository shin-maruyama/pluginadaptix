...
(async function ($, PLUGIN_ID) {
  ...
  const obj = {
    ...
    indexEvents: 'mobile.app.record.index.show',
    ...
    execution: async function ({ settings }) {
      ...
      for (let i = 0, len = settings.length; i < len; i++) {
        ...
        const destinationRe = await obj.getFieldList(kintone.mobile.app.getId());
    ...
    createFieldChangeEvent: function ({ setting, insideTheTable = false }) {
      if (insideTheTable) {
        return [
          `mobile.app.record.create.change.${setting.inputFieldCode1.split('　')[1]}`,
          `mobile.app.record.create.change.${setting.inputFieldCode2.split('　')[1]}`,
          `mobile.app.record.create.change.${setting.inputFieldCode3.split('　')[1]}`,
          `mobile.app.record.edit.change.${setting.inputFieldCode1.split('　')[1]}`,
          `mobile.app.record.edit.change.${setting.inputFieldCode2.split('　')[1]}`,
          `mobile.app.record.edit.change.${setting.inputFieldCode3.split('　')[1]}`
        ];
      } else {
        return [
          `mobile.app.record.create.change.${obj.getCodePart(setting.inputFieldCode1)}`,
          `mobile.app.record.create.change.${obj.getCodePart(setting.inputFieldCode2)}`,
          `mobile.app.record.create.change.${obj.getCodePart(setting.inputFieldCode3)}`,
          `mobile.app.record.edit.change.${obj.getCodePart(setting.inputFieldCode1)}`,
          `mobile.app.record.edit.change.${obj.getCodePart(setting.inputFieldCode2)}`,
          `mobile.app.record.edit.change.${obj.getCodePart(setting.inputFieldCode3)}`
        ];
      }
    },
    ...
    checkFields: async function (e) {
      const destinationFields = await obj.getFieldList(kintone.mobile.app.getId());
