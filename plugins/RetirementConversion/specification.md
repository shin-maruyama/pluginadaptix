...
### コード上で確認できた概要
[PluginAdaptiX] v1.0.5 cybozu共通管理に登録されていたユーザーが運用上いなくなった場合、そのユーザー情報を指定したユーザーに置き換えるプラグインです。

## 2. ファイル構成

- 対象パス: `plugins/RetirementConversion`
- 元ソース: `plugins/RetirementConversion/RetirementConversion`
...
- version: 1.0.5
- type: APP
- name.ja: 退職者チェックプラグイン
- name.en: appName
- description.ja: [PluginAdaptiX] v1.0.5 cybozu共通管理に登録されていたユーザーが運用上いなくなった場合、そのユーザー情報を指定したユーザーに置き換えるプラグインです。
- icon: image/icon.png
...
- 元ソース優先: plugins/RetirementConversion/RetirementConversion
- 難読化済みファイル: plugins/RetirementConversion/RetirementConversione（参考情報として扱い、直接修正対象外）
