...
```text
plugins/SubtableMaxValue/SubtableMaxValue
```

## 難読化版場所

```text
plugins/SubtableMaxValue/SubtableMaxValuee
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/SubtableMaxValue/SubtableMaxValue`
- 難読化版: `plugins/SubtableMaxValue/SubtableMaxValuee`
...
1. `plugins/SubtableMaxValue/specification.md` を確認する。
2. `plugins/SubtableMaxValue/codex/troubleshooting.md`、`plugins/SubtableMaxValue/codex/handover-YYYY-MM-DD.md`、`plugins/SubtableMaxValue/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/SubtableMaxValue/SubtableMaxValue` であること。
- 難読化済みファイル `plugins/SubtableMaxValue/SubtableMaxValuee` を直接編集していないこと。
- `plugins/SubtableMaxValue/SubtableMaxValue/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/SubtableMaxValue/SubtableMaxValue` から実行します。
- 難読化済みファイルは `plugins/SubtableMaxValue/SubtableMaxValuee` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/SubtableMaxValue/SubtableMaxValue` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/SubtableMaxValue/SubtableMaxValuee` の `contents` 配下を基準に作成します。
...
```text
plugins/SubtableMaxValue/codex/handover-YYYY-MM-DD.md
plugins/SubtableMaxValue/codex/next-tasks.md
```
...
```text
SubtableMaxValue-v<version>.zip
```

難読化版ZIP:

```text
SubtableMaxValue-ev<version>.zip
```
...
```text
plugins/SubtableMaxValue/decisions/
plugins/SubtableMaxValue/codex/troubleshooting.md
```
