...
```text
plugins/キーワードルックアップ/KeywordLookup
```

## 難読化版場所

```text
plugins/キーワードルックアップ/KeywordLookupe
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/キーワードルックアップ/KeywordLookup`
- 難読化版: `plugins/キーワードルックアップ/KeywordLookupe`
...
1. `plugins/キーワードルックアップ/specification.md` を確認する。
2. `plugins/キーワードルックアップ/codex/troubleshooting.md`、`plugins/キーワードルックアップ/codex/handover-YYYY-MM-DD.md`、`plugins/キーワードルックアップ/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/キーワードルックアップ/KeywordLookup` であること。
- 難読化済みファイル `plugins/キーワードルックアップ/KeywordLookupe` を直接編集していないこと。
- `plugins/キーワードルックアップ/KeywordLookup/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/キーワードルックアップ/KeywordLookup` から実行します。
- 難読化済みファイルは `plugins/キーワードルックアップ/KeywordLookupe` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/キーワードルックアップ/KeywordLookup` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/キーワードルックアップ/KeywordLookupe` の `contents` 配下を基準に作成します。
...
```text
plugins/キーワードルックアップ/codex/handover-YYYY-MM-DD.md
plugins/キーワードルックアップ/codex/next-tasks.md
```
...
```text
KeywordLookup-v<version>.zip
```

難読化版ZIP:

```text
KeywordLookup-ev<version>.zip
```
