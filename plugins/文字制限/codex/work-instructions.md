...
```text
plugins/文字制限/CharacterLimit
```

## 難読化版場所

```text
plugins/文字制限/CharacterLimite
```

## 元ソースと難読化版の対応関係

- 元ソース: `plugins/文字制限/CharacterLimit`
- 難読化版: `plugins/文字制限/CharacterLimite`
...
1. `plugins/文字制限/specification.md` を確認する。
2. `plugins/文字制限/codex/troubleshooting.md`、`plugins/文字制限/codex/handover-YYYY-MM-DD.md`、`plugins/文字制限/codex/next-tasks.md` を確認する。
...
- 修正対象が元ソース `plugins/文字制限/CharacterLimit` であること。
- 難読化済みファイル `plugins/文字制限/CharacterLimite` を直接編集していないこと。
- `plugins/文字制限/CharacterLimit/contents/manifest.json` が存在すること。
...
- 要確認
- 難読化は元ソース `plugins/文字制限/CharacterLimit` から実行します。
- 難読化済みファイルは `plugins/文字制限/CharacterLimite` に生成されるものとして扱います。
- 難読化済みファイルは直接修正しません。
...
- 通常版ZIPは元ソース `plugins/文字制限/CharacterLimit` の `contents` 配下を基準に作成します。
- 難読化版ZIPは難読化済み版 `plugins/文字制限/CharacterLimite` の `contents` 配下を基準に作成します。
...
```text
plugins/文字制限/codex/handover-YYYY-MM-DD.md
plugins/文字制限/codex/next-tasks.md
```
