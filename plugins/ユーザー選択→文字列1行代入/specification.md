...
- 対象パス: `plugins/ユーザー選択→文字列1行代入`
- 元ソース: `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment`
- 難読化済み版: `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente`
- 解析対象ファイル数: 33
- ファイル種別集計: CSS: 8, HTML: 2, JS: 8, JSON: 2, MD: 7, PNG: 2, PUBKEY: 2, SIGNATURE: 2

### 元ソース主要ファイル
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/css/51-modern-default.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/css/config.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/css/desktop.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/css/mobile.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/html/config.html`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/image/icon.png`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/js/certification.js`
...
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/contents/manifest.json`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/PUBKEY`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/css/51-modern-default.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/css/config.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/css/desktop.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/css/mobile.css`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/html/config.html`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/image/icon.png`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/js/certification.js.obfuscated.js`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/js/config.js.obfuscated.js`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/js/desktop.js.obfuscated.js`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/js/mobile.js.obfuscated.js`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/contents/manifest.json`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/PUBKEY`
- `plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente/SIGNATURE`
...
- version: 2.0.7
- type: APP
- name.ja: ユーザー選択→文字列1行代入プラグイン_test
- name.en: appName
- description.ja: [PluginAdaptiX] v2.0.7 ユーザー選択で選択されたユーザー名を文字列（1行）に代入します。
- icon: image/icon.png
...
- 元ソース優先: plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignment
- 難読化済みファイル: plugins/ユーザー選択→文字列1行代入/UserSelectStringAssignmente（参考情報として扱い、直接修正対象外）
