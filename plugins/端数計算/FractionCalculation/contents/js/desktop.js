  ...
  const obj = {
    ...
    init : function(e) {
      ...
      for(const setting of obj.config.settings) {
        ...
        events.push('app.record.edit.change.'   + obj.getCodePart(setting.target));
        events.push('app.record.create.change.' + obj.getCodePart(setting.target));
        events.push('app.record.edit.change.'   + obj.getCodePart(setting.method));
        events.push('app.record.create.change.' + obj.getCodePart(setting.method));
        events.push('app.record.edit.change.'   + obj.getCodePart(setting.location));
        events.push('app.record.create.change.' + obj.getCodePart(setting.location));
      }
