# SubTableAutosorte バグ修正準備計画

作業日: 2026-06-26

## 1. 修正対象バグ

- BUG-008: No.1 2026-24-06 BUG-008 mobile.jsの保存後ソート処理でdesktop APIのgetIdを使用している

## 2. 優先順位

1. BUG-008: 重大度 High、確度 高確度
...
- BUG-008: applySortByPut（183行付近）

## 5. 修正方針

- BUG-008: mobile用のappId取得関数を共通化し、全箇所で利用する。

## 6. 影響範囲

- BUG-008: 高 - モバイル保存後のサブテーブル自動ソートが失敗する可能性がある。
