...
```text
plugins/SubTableAutosorte/SubTableAutosort
```
...
- 難読化版: `plugins/SubTableAutosorte/SubTableAutosorte`
...
1. `plugins/SubTableAutosorte/specification.md` を確認する。
2. `plugins/SubTableAutosorte/codex/troubleshooting.md`、`plugins/SubTableAutosorte/codex/handover-YYYY-MM-DD.md`、`plugins/SubTableAutosorte/codex/next-tasks.md` を確認する。
...
```text
plugins/SubTableAutosorte/decisions/
plugins/SubTableAutosorte/codex/troubleshooting.md
```
