...
- 対象パス: `plugins/ConditionalElapsedTimeAutomaticCalculation`
...
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculation/contents/html/config.html`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculation/contents/image/icon.png`
...
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculation/contents/manifest.json`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculation/PUBKEY`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculation/SIGNATURE`

### 難読化済み・生成物として扱うファイル
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/css/51-modern-default.css`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/css/config.css`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/css/desktop.css`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/css/mobile.css`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/html/config.html`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/image/icon.png`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/js/certification.js.obfuscated.js`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/js/config.js.obfuscated.js`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/js/desktop.js.obfuscated.js`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/js/mobile.js.obfuscated.js`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/contents/manifest.json`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/PUBKEY`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione/SIGNATURE`

### 保守資料・その他
- `plugins/ConditionalElapsedTimeAutomaticCalculation/codex/handover-2026-06-23.md`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/codex/next-tasks.md`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/codex/test-plan.md`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/codex/troubleshooting.md`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/codex/work-instructions.md`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/decisions/README.md`
- `plugins/ConditionalElapsedTimeAutomaticCalculation/specification.md`
...
- 元ソース優先: plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculation
- 難読化済みファイル: plugins/ConditionalElapsedTimeAutomaticCalculation/ConditionalElapsedTimeAutomaticCalculatione（参考情報として扱い、直接修正対象外）
