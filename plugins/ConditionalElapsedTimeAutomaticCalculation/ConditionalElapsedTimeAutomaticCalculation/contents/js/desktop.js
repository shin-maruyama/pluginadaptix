...
(async function ($, PLUGIN_ID) {
  ...
  obj.eventStart = function () {
    ...
    that.events.push('app.record.create.change.' + that.getCodePart(config.startDate));
    that.events.push('app.record.edit.change.' + that.getCodePart(config.startDate));
    that.events.push('app.record.create.change.' + that.getCodePart(config.endDate));
    that.events.push('app.record.edit.change.' + that.getCodePart(config.endDate));
