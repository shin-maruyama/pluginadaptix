# ConditionalElapsedTimeAutomaticCalculation 次回作業予定
...
6. ZIPを作成する場合は、通常版 `ConditionalElapsedTimeAutomaticCalculation-v<version>.zip` と難読化版 `ConditionalElapsedTimeAutomaticCalculation-ev<version>.zip` の作成要否を記録する。
